...
class RequestInfo(object):
    ...
    def __init__(self, user, session_key, system_authtoken, server_rest_uri, server_hostname, \
...
class RESTHandler(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        try:
            ...
            # log
            self.logger.debug("cred_rest_handler, handling incoming request.")
            ...
            request_info = RequestInfo(user, session_key, system_authtoken, server_rest_uri, server_hostname, \
